...
public class Util {
	...
	if(diff == 0) {
	    ...
	    }else return context.getString(R.string.vor) + diff / 7 + context.getString(R.string.weeks_ago_pl);
	}else if(diff > 30 && diff < 365) {
	    if(diff / 7 == 1) {
		return context.getString(R.string.vor) + diff / 30 + context.getString(R.string.months_ago_sg);
	    }else return context.getString(R.string.vor) + diff / 30 + context.getString(R.string.months_ago_pl);
	}else {
